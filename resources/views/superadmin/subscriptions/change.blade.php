    ...
    <div class="max-w-4xl mx-auto px-6 py-10">
        <div class="bg-white shadow-lg rounded-2xl p-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Upgrade/Downgrade a School's Plan</h1>
            ...
            @else
                <form action="{{ route('superadmin.subscriptions.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Select School --}}
                        <div>
                            <label for="school_id" class="block text-sm font-medium text-gray-700 mb-1">Select School (Only schools with active plans are listed)</label>
                        ...
                        {{-- New Plan Start Date --}}
                        <div>
                            <label for="start_date" class="block text-sm font-medium text-gray-700 mb-1">New Plan Start Date</label>

    ...
    <div class="max-w-4xl mx-auto px-6 py-10">
        <div class="bg-white shadow-lg rounded-2xl p-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-4 md:mb-0">Edit Branch: {{ $branch->name }}</h1>
                <a href="{{ route('superadmin.schools.branches.index', $school) }}" class="text-blue-600 hover:underline">← Back to Branch List</a>
            </div>

            <form action="{{ route('superadmin.schools.branches.update', [$school, $branch]) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')

...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('school-superadmin.branches.create') }}"
                    ...
                    @forelse ($branches as $branch)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('school-superadmin.branches.edit', $branch) }}"
                                    class="text-blue-600 hover:text-blue-900">Edit</a>
                                <form action="{{ route('school-superadmin.branches.destroy', $branch) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No
                                branches found. Create your first one!</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

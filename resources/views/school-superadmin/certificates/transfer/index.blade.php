...
<div
    ...
    <form method="GET" :action="selectedStudentId ? '{{ route('school-superadmin.certificates.transfer.prepare', ['student' => ':id']) }}'.replace(':id', selectedStudentId) : '#'" target="_blank" x-ref="generateForm">

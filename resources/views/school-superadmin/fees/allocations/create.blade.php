    ...
    <div class="max-w-4xl mx-auto px-6 py-10" x-data="feeAllocationForm()">
        <div class="bg-white shadow-lg rounded-2xl p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Allocate Fee to Class</h1>
            ...
            {{-- Form --}}
            <form action="{{ route('school-superadmin.fee-allocations.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="branch_id" id="branch_id" x-model="selectedBranchId" @change="loadClasses()" required
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 @error('branch_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <select name="academic_class_id" id="academic_class_id" x-model="selectedClassId" required
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 @error('academic_class_id') border-red-500 @enderror">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="fee_type_id" id="fee_type_id" required
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 @error('fee_type_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="amount" id="amount" value="{{ old('amount') }}"
                            required
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 @error('amount') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="date" name="due_date" id="due_date"
                            ...
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:border-blue-500 @error('due_date') border-red-500 @enderror">
                        @error('due_date')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>

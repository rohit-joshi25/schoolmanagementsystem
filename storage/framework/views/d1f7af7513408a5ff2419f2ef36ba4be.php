...
<div
    ...
    <form method="GET" :action="selectedStudentId ? '<?php echo e(route('school-superadmin.certificates.transfer.prepare', ['student' => ':id'])); ?>'.replace(':id', selectedStudentId) : '#'" target="_blank" x-ref="generateForm">
...
<?php echo $__env->make('layouts.school-superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sms\resources\views/school-superadmin/certificates/transfer/index.blade.php ENDPATH**/ ?>